    ...
    */
    ...
    public:
        ...
        */  
        ...
        /*
         * Initializes instanced rendering for all meshes in the model
         */
        void initialize_instances(const std::vector<glm::mat4> &instances);
        /*
         * Draws all model meshes using instanced rendering
         */
        void draw_instanced(const Shader* shader, const int size);
